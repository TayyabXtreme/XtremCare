            ...
            <form onSubmit={handleVerification} className="space-y-4">
              <div>
                ...
                <div className="flex justify-center">
                  ...
                  >
                    <InputOTPGroup>
                      <InputOTPSlot index={0} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                      <InputOTPSlot index={1} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                      <InputOTPSlot index={2} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                      <InputOTPSlot index={3} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                      <InputOTPSlot index={4} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                      <InputOTPSlot index={5} className="w-11 h-11 text-lg border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-900/50" />
                    </InputOTPGroup>
                  </InputOTP>
                </div>
              </div>
